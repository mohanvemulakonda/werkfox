...
export default function CreateMaterialRequestPage() {
  ...
  const [items, setItems] = useState<ItemRow[]>([{ productId: null, productName: '', requestedQuantity: 1 }]);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(`/admin/erp/material-requests/${result.id}`);
    } catch (err: any) {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2 font-open-sans">New Material Request</h1>
        <p className="text-gray-600 font-inter font-light">Create a material requisition</p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="admin-form-section">
          ...
          <div className="admin-form-row">
            <div className="admin-form-group">
              <label className="admin-form-label">Production Order (Optional)</label>
        ...
        <div className="admin-form-section">
          ...
          <button type="button" onClick={() => setItems(prev => [...prev, { productId: null, productName: '', requestedQuantity: 1 }])} className="mt-3 text-sm text-blue-600 hover:text-blue-700 font-medium">
            + Add Item
          </button>
        </div>
