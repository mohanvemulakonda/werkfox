      ...
      <div className="flex items-center justify-between px-8 py-4">
        <div className="flex items-center gap-4">
          <Link href="/admin" className="flex items-center gap-3">
            ...
            />
            <div>
              <h1 className="text-lg font-bold text-gray-900 font-open-sans">Livato Admin</h1>
        ...
        <div className="flex items-center gap-4">
          <div className="text-right">
            <p className="text-sm font-medium text-gray-900 font-inter">{user?.name}</p>
            <p className="text-xs text-gray-500 font-inter">{user?.email}</p>
          </div>
          <button
            onClick={() => signOut({ callbackUrl: '/login/admin' })}
            className="group relative inline-flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 overflow-hidden font-inter"
          >
