    ...
    <>
      ...
      <main className="relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl lg:text-6xl font-light tracking-tight mb-6 font-open-sans">
                  MEDICAL DEVICE <span className="text-gray-900">LABELS</span>
                </h1>
              ...
              <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 text-white">
                  <p className="text-2xl font-semibold mb-2 font-open-sans">FDA Compliant Labels</p>
        ...
        <section className="py-24 bg-white">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 className="text-3xl font-semibold mb-12 text-center font-open-sans">Medical Device Label Applications</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 border-2 border-blue-200 hover:shadow-xl transition-shadow">
                  ...
                  <h3 className="text-xl font-semibold mb-2 font-open-sans">{app.name}</h3>
        ...
        <section className="py-24 bg-gray-50">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 className="text-3xl font-semibold mb-12 text-center font-open-sans">Regulatory Compliance</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="bg-white rounded-xl p-6 shadow-lg text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-2 font-open-sans">{item.title}</h3>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {[
                ...
                <div key={i} className="bg-gradient-to-br from-blue-50 to-white rounded-xl p-8 border-2 border-blue-200">
                  <h3 className="text-2xl font-semibold mb-4 text-gray-900 font-open-sans">{mat.name}</h3>
        ...
        <section className="py-20 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
          <div className="mx-auto max-w-4xl px-6 text-center">
            <h2 className="text-4xl font-semibold mb-6 font-open-sans">Need FDA Compliant Medical Device Labels?</h2>
            <p className="text-xl text-blue-100 mb-8 font-inter">
              Get expert consultation and compliant labeling solutions
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact?solution=medical-device-labels" className="px-8 py-4 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg">
                Request Consultation
              </Link>
              <Link href="/solutions" className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-colors">
