      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          <div className="lg:col-span-5">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-lg bg-gray-100 hover:bg-blue-100 flex items-center justify-center transition-colors group">
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-xs">
            <Link href="/privacy" className="text-gray-500 hover:text-blue-600 transition-colors font-inter">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-gray-500 hover:text-blue-600 transition-colors font-inter">
              Terms of Service
            </Link>
          </div>
        </div>
