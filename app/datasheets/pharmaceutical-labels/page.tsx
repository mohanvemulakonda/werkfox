...
export default function PharmaceuticalLabelsDatasheet() {
  const handlePrint = () => {
    window.print();
  };
    ...
    <>
      ...
      <div className="no-print sticky top-0 z-50 bg-gray-900 border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-lg font-semibold text-white">Pharmaceutical Labels - Product Datasheet</h1>
    ...
    <>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs uppercase tracking-widest text-gray-600 font-medium">Healthcare Solution</span>
        </div>
        <h2 className="text-4xl font-light mb-3">
          PHARMACEUTICAL <span className="font-semibold">LABELS</span>
        </h2>
        <p className="text-gray-600 font-light leading-relaxed max-w-3xl">
          FDA-compliant pharmaceutical labeling solutions for medicine bottles, vials, and packaging. Complete ecosystem ensuring regulatory compliance and patient safety.
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        <div className="col-span-2 grid grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-lg border border-gray-200">
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              <li>• Medicine bottles and vials</li>
              <li>• Prescription labels</li>
              <li>• Blister pack labeling</li>
              <li>• Compliance and warning labels</li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-lg border border-gray-200">
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <li>• GMP certified materials</li>
              <li>• Tamper-evident options</li>
              <li>• Variable data printing capable</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-white border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center">
          ...
          <p className="text-xs text-gray-400 text-center">Vial Label</p>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-200">
              <tr className="bg-white">
                <td className="p-3 font-medium">Coated Paper</td>
                <td className="p-3 text-gray-600">-10°C to 50°C (14°F to 122°F)</td>
                <td className="p-3 text-gray-600">Prescription labels</td>
                <td className="p-3 text-gray-600">FDA approved</td>
              </tr>
              <tr className="bg-white">
                <td className="p-3 font-medium">Polyester</td>
                <td className="p-3 text-gray-600">-40°C to 150°C (-40°F to 302°F)</td>
                <td className="p-3 text-gray-600">Vials & ampoules</td>
                <td className="p-3 text-gray-600">GMP certified</td>
              </tr>
              <tr className="bg-white">
                <td className="p-3 font-medium">Synthetic</td>
                <td className="p-3 text-gray-600">-20°C to 80°C (-4°F to 176°F)</td>
                <td className="p-3 text-gray-600">Blister packs</td>
                <td className="p-3 text-gray-600">FDA compliant</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <p className="text-xs text-gray-600 mb-3">For pharmaceutical compliance</p>
            <ul className="space-y-1 text-xs text-gray-700">
              <li>" Smudge-resistant printing</li>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h4 className="font-semibold mb-2">Premium Resin Ribbon</h4>
            <p className="text-xs text-gray-600 mb-3">For extreme durability</p>
            <ul className="space-y-1 text-xs text-gray-700">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="border border-gray-200 rounded-lg p-4 text-center">
            <h4 className="font-semibold text-sm mb-1">Livato PrintPro 400HD</h4>
            <p className="text-xs text-gray-600 mb-2">Desktop Printer</p>
            <div className="text-xs text-gray-700">4 inch width</div>
            <div className="text-xs text-gray-700">300 DPI</div>
          </div>

          <div className="border border-gray-200 rounded-lg p-4 text-center">
            <h4 className="font-semibold text-sm mb-1">Zebra ZD620</h4>
            <p className="text-xs text-gray-600 mb-2">Healthcare Printer</p>
            <div className="text-xs text-gray-700">4 inch width</div>
            <div className="text-xs text-gray-700">300 DPI</div>
          </div>

          <div className="border border-gray-200 rounded-lg p-4 text-center">
            <h4 className="font-semibold text-sm mb-1">SATO CG408</h4>
          ...
          <div className="border border-gray-200 rounded-lg p-4 text-center">
            <h4 className="font-semibold text-sm mb-1">Livato IndustrialMax 4HD</h4>
            <p className="text-xs text-gray-600 mb-2">Industrial Printer</p>
            <div className="text-xs text-gray-700">4 inch width</div>
            <div className="text-xs text-gray-700">300 DPI</div>
          </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="border border-gray-200 rounded-lg p-4 text-center">
            <div className="font-semibold">50mm x 75mm</div>
            <div className="text-xs text-gray-600">Medicine bottles</div>
          </div>
          <div className="border border-gray-200 rounded-lg p-4 text-center">
            <div className="font-semibold">75mm x 100mm</div>
            <div className="text-xs text-gray-600">Prescription labels</div>
          </div>
          <div className="border border-gray-200 rounded-lg p-4 text-center">
            <div className="font-semibold">25mm x 50mm</div>
            <div className="text-xs text-gray-600">Vial labels</div>
          </div>
        </div>
